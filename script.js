...
const A = [
  {
    id:'apr-c', month:'Apr', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'🌸',
    title:'Wellness at Work', sub:'World Health Day',
  ...
  },
  {
    ...
    title:'Food Truck', sub:'April Edition',
    tip:'A food truck rolling into the office courtyard with a fresh menu for the month.',
    what:'A food truck parks in the office courtyard and fires up a fresh menu — bringing a completely different cuisine experience right to the office. The food truck format creates a break from the ordinary and turns lunch into a shared outdoor moment.',
  ...
  {
    id:'may-c', month:'May', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'☀️',
    title:'Beat the Summer', sub:'Peak Summer Activation',
  ...
  {
    id:'may-g', month:'May', layer:'L3 — Game Days', lc:'#3DB87A', emoji:'🏏',
    title:'Cricket Game Day', sub:'IPL · Non-Food Engagement',
  ...
  {
    id:'jun-c', month:'Jun', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'🌿',
    title:'Planet on a Plate', sub:'World Environment Day',
  ...
  {
    id:'jun-b', month:'Jun', layer:'L2 — Buzzar', lc:'#E8534A', emoji:'🌾',
    title:'Millet & Earth Bites', sub:'Jowar · Ragi · Bajra',
  ...
  {
    id:'jun-p', month:'Jun', layer:'L5 — Purpose Led Pop-Up', lc:'#C0397A', emoji:'♻️',
    title:'Sustainability Drive', sub:'Zero waste · Eco ventures',
    ...
    fmt:[
      ...
      {i:'📋', l:'Founder Story Cards',    d:'Each stall features the founder\'s journey in a visual display'},
      {i:'🌿', l:'Green Pledge Wall',      d:'Employees commit to one sustainability habit for the month'}
    ]
  },
  {
    id:'jul-c', month:'Jul', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'🌧️',
    title:'Monsoon Munch Fest', sub:'Season Comfort Foods',
  ...
  },
  {
    ...
    title:'Food Truck', sub:'July Edition',
    tip:'A food truck rolling into the office courtyard with a fresh menu for the month.',
    what:'A food truck parks in the office courtyard bringing a completely different cuisine experience right to the office. The food truck format creates a break from the ordinary and turns the monsoon lunch hour into something to look forward to.',
  ...
  {
    id:'aug-c', month:'Aug', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'🇮🇳',
    title:'Flavours of India', sub:'Independence Day',
  ...
  {
    id:'aug-p', month:'Aug', layer:'L5 — Purpose Led Pop-Up', lc:'#C0397A', emoji:'🛖',
    title:'Local Entrepreneurs', sub:'Homegrown brands & makers',
    ...
    fmt:[
      ...
      {i:'📖', l:'Brand Story Displays',    d:'Visual boards sharing each founder\'s story and journey'},
      {i:'📲', l:'Discovery Cards',         d:'QR codes linking to each brand\'s online presence'}
    ]
  },
  {
    id:'sep-c', month:'Sep', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'🎓',
    title:'Mentors Week', sub:'Guidance & Gratitude',
  ...
  {
    id:'sep-b', month:'Sep', layer:'L2 — Buzzar', lc:'#E8534A', emoji:'☔',
    title:'Monsoon Snack Market', sub:'Bhajiya · Hot Soups',
  ...
  {
    id:'oct-c', month:'Oct', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'🪔',
    title:'Dandiya & Delicacies', sub:'Navratri · Festive Spirit',
  ...
  {
    id:'oct-p', month:'Oct', layer:'L5 — Purpose Led Pop-Up', lc:'#C0397A', emoji:'👩‍💼',
    title:'Women-Led Ventures', sub:'She builds · She leads',
    ...
    fmt:[
      ...
      {i:'📋',   l:'Founder Story Wall',     d:'Visual displays sharing each founder\'s journey and inspiration'},
      {i:'🛍️',  l:'Shop & Support',         d:'All products available to purchase directly at the stall'}
    ]
  },
  {
    id:'nov-c', month:'Nov', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'✨',
    title:'Lights & Delights', sub:'Diwali · Sparkle & Sweets',
  ...
  },
  {
    ...
    title:'Food Truck', sub:'November Edition',
    tip:'A food truck rolling into the office courtyard with a fresh menu for the month.',
  ...
  {
    id:'dec-c', month:'Dec', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'🎄',
    title:'Wish-mas Festival', sub:'Year-End Festive Cheer',
  ...
  {
    id:'dec-b', month:'Dec', layer:'L2 — Buzzar', lc:'#E8534A', emoji:'🔥',
    title:'Winter Warmth Bazaar', sub:'Gajak · Hot Cocoa',
  ...
  {
    id:'dec-g', month:'Dec', layer:'L3 — Game Days', lc:'#3DB87A', emoji:'🏎️',
    title:'F1 Game Day', sub:'Non-Food Engagement · Pit stop bites',
  ...
  {
    id:'jan-c', month:'Jan', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'🪁',
    title:'Festival of Kites', sub:'Sankranti · Heritage',
  ...
  },
  {
    ...
    title:'Food Truck', sub:'January Edition',
    tip:'A food truck rolling into the office courtyard with a fresh menu for the month.',
    what:'A food truck kicks off the new year in the office courtyard — bringing a fresh cuisine experience that makes January feel like anything but a slow start. A dedicated truck with a rotating menu turns ordinary lunch into a culinary discovery.',
  ...
  {
    id:'feb-c', month:'Feb', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'💛',
    title:'Dil-Licious February', sub:'Wellness & Self-Love',
  ...
  {
    id:'feb-p', month:'Feb', layer:'L5 — Purpose Led Pop-Up', lc:'#C0397A', emoji:'🤝',
    title:'Differently Abled Ventures', sub:'Inclusivity in action',
    ...
    fmt:[
      ...
      {i:'🎥', l:'Story Wall & Video Displays',   d:'Video stories of each founder playing at the pop-up'},
      {i:'🛍️', l:'Buy & Impact Directly',        d:'100% of proceeds go directly to the founders'}
    ]
  },
  {
    id:'mar-c', month:'Mar', layer:'L1 — Monthly Campaign', lc:'#F5A623', emoji:'🎨',
    title:'Rangotsav', sub:'Holi · Color Carnival',
  ...
  {
    id:'mar-b', month:'Mar', layer:'L2 — Buzzar', lc:'#E8534A', emoji:'🛒',
    title:'Street Food Fiesta', sub:'Pani Puri · Chaat',
...
// Month → row mapping [L1, L2, L3, L4, L5]
const MONTHS = [
  ...
  {name:'Nov', num:'11', ids:['nov-c', null,    null,    'nov-t', null   ]},
  {name:'Dec', num:'12', ids:['dec-c', 'dec-b', 'dec-g', null,    null   ]},
...
const ROW_CLASSES  = ['cell-r1','cell-r2','cell-r3','cell-r4','cell-r5'];
const CARD_CLASSES = ['card-campaign','card-buzzar','card-gameday','card-truck','card-purpose'];
...
MONTHS.forEach(m => {
  ...
  m.ids.forEach((id, i) => {
    ...
    cell.className = `cell ${ROW_CLASSES[i]}`;

    if (id && aMap[id]) {
      const a = aMap[id];
      cell.innerHTML = `
        <div class="card ${CARD_CLASSES[i]}" data-id="${id}">
...
document.addEventListener('click', e => {
  ...
  document.getElementById('dTags').innerHTML    = a.tags.map(t => `<span class="dtag">${t}</span>`).join('');
  document.getElementById('dFormat').innerHTML  = a.fmt.map(f =>
